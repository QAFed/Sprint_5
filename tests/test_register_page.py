...
class TestRegisterPage:
    def test_register_form_if_name_email_pass_correct_go_auth_page(self, driver):
    ...
    def test_alert_text_if_pass_less_than_6_char(self, driver):
        new_user = LoginPassName()
        bad_pass = '12345'
        driver.get(URLpage.REGISTER)
        WebDriverWait(driver, 10).until(
    ...
    def test_link_login_if_click_open_login_page(self, driver):
        driver.get(URLpage.REGISTER)
