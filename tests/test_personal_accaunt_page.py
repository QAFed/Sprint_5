...
from locators import PersonXpath
...
class TestPersonalPage:
    def test_open_personal_account_page_if_user_is_login(self, driver_with_login_user):
    ...
    def test_link_constructor_click_open_start_page(self, driver_with_login_user):
        driver_with_login_user.get(URLpage.START)
        WebDriverWait(driver_with_login_user, 10).until(
               expected_conditions.visibility_of_element_located((By.XPATH, StartXpath.button_personal_account)))
        driver_with_login_user.find_element(By.XPATH, StartXpath.button_personal_account).click()
    ...
    def test_link_logo_click_open_start_page(self, driver_with_login_user):
        driver_with_login_user.get(URLpage.START)
        WebDriverWait(driver_with_login_user, 10).until(
            expected_conditions.visibility_of_element_located((By.XPATH, StartXpath.button_personal_account)))
        driver_with_login_user.find_element(By.XPATH, StartXpath.button_personal_account).click()
    ...
    def test_button_exit_click_logout(self, driver_with_login_user):
        driver_with_login_user.get(URLpage.START)
        WebDriverWait(driver_with_login_user, 10).until(
            expected_conditions.visibility_of_element_located((By.XPATH, StartXpath.button_personal_account)))
        driver_with_login_user.find_element(By.XPATH, StartXpath.button_personal_account).click()
        WebDriverWait(driver_with_login_user, 10).until(
            expected_conditions.visibility_of_element_located((By.XPATH, PersonXpath.button_exit)))
        driver_with_login_user.find_element(By.XPATH, PersonXpath.button_exit).click()
        WebDriverWait(driver_with_login_user, 10).until(
